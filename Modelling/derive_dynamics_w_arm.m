...
syms q1 q2 dq1 dq2 ddq1 ddq2 q3 q4 dq3 dq4 ddq3 ddq4 tau1 tau2 tau3 real
syms l_OA l_AB l_BC l_CD l_AE l_Omp l_Amb l_Bm1 l_Cm2 l_Am3 mp mb m1 m2 m3 Ip Ib I1 I2 I3 Ir N g nz real
% mp = pendulum mass, mb = body, m1 = link 1/thigh , m2 = link 2/leg m3 =
% link3/arm
...
rE = rA + [l_AE*sin(q1+q4);0;-l_AE*cos(q1+q4)]; % arm
...
r_m3 = rA + [l_Am3*sin(q1+q4); 0; -l_Am3*cos(q1+q4)]; % CM of arm
...
keypoints = [rA(1) rB(1) rC(1) rD(1) rE(1);
             rA(3) rB(3) rC(3) rD(3) rE(3)];
...
matlabFunction(A,'file',['./AutoDerived/A_foot_and_arm'],'vars',{z p});
matlabFunction(b,'file',['./AutoDerived/b_foot_and_arm'],'vars',{z u p});
matlabFunction(E,'file',['./AutoDerived/energy_foot_and_arm' ],'vars',{z p});
matlabFunction(rD,'file',['./AutoDerived/position_foot_and_arm'],'vars',{z p});
matlabFunction(drD,'file',['./AutoDerived/velocity_foot_and_arm'],'vars',{z p});
matlabFunction(J ,'file',['./AutoDerived/jacobian_foot_and_arm'],'vars',{z p});
matlabFunction(dJ ,'file',['./AutoDerived/jacobian_dot_foot_and_arm'],'vars',{z p});

matlabFunction(Mass_Joint_Sp, 'file', './AutoDerived/Mass_matrix_foot_and_arm', 'vars', {z,p});
matlabFunction(Grav_Joint_Sp ,'file', ['./AutoDerived/Grav_foot_and_arm'] ,'vars',{z p});
matlabFunction(Corr_Joint_Sp ,'file', ['./AutoDerived/Corr_foot_and_arm']     ,'vars',{z p});
matlabFunction(keypoints,'file',['./AutoDerived/keypoints_foot_and_arm'],'vars',{z p});
