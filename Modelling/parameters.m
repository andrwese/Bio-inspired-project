...
mb = 1.55;              % body mass
m1 =.0393 + .2;         % thigh mass      
m2 =.0368;              % leg mass

Ip = 9.25 * 10^-6;      % Inertia of pendulum
Ib = 22.176 * 10^-6;    % Inertia of body
I1 = 25.1 * 10^-6;      % Inertia of hip
I2 = 53.5 * 10^-6;      % Inertia of knee

l_OA=.20;               % length from origin to end of pendulum
